...
const NextClassCard: React.FC<NextClassCardProps> = ({ date, turmaName, quadraName, professorName, startTime, arenaName }) => {
  return (
    <motion.div
      ...
      className="bg-white dark:bg-brand-gray-800 rounded-lg shadow-lg border border-brand-gray-200 dark:border-brand-gray-700 overflow-hidden flex flex-col border-l-4 border-blue-500"
    >
      <div className="p-5 flex-1">
        <h3 className="font-bold text-lg text-brand-gray-900 dark:text-white mb-2">{turmaName}</h3>
        <p className="text-sm text-brand-gray-500 mb-4">Sua próxima aula como aluno</p>
