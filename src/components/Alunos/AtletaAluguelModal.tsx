...
const AtletaAluguelModal: React.FC<AtletaAluguelModalProps> = ({ isOpen, onClose, onSave, onDelete, initialData, alunos }) => {
  const [formData, setFormData] = useState({
    ...
    nivel_tecnico: null as AtletaAluguel['nivel_tecnico'],
    experiencia_anos: 0,
    raio_atuacao: 0,
    taxa_hora: 0,
    comissao_arena: 10,
          ...
          >
            <div className="flex justify-between items-center p-6 border-b border-brand-gray-200 dark:border-brand-gray-700">
              <h3 className="text-xl font-semibold text-brand-gray-900 dark:text-white">
                {isEditing ? 'Editar Atleta' : 'Cadastrar Novo Atleta de Aluguel'}
              </h3>
            ...
            <div className="p-6 space-y-6 overflow-y-auto">
              <Section title="Conta de Usuário (Opcional)">
                <p className="text-sm -mt-2 text-brand-gray-500 dark:text-brand-gray-400">Vincule este perfil a uma conta de usuário existente para que ele possa receber notificações e gerenciar suas atividades.</p>
                <div>
...
export default AtletaAluguelModal;
