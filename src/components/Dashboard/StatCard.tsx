...
const StatCard: React.FC<StatCardProps> = ({ icon: Icon, label, value, description, color, index, trend, className }) => {
  const colors = {
    blue: 'text-blue-500',
  ...
  return (
    <motion.div
      ...
      className={cn("bg-white dark:bg-brand-gray-800 rounded-xl shadow-lg p-6 border border-brand-gray-200 dark:border-brand-gray-700 h-full flex flex-col", className)}
    >
