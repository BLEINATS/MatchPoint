    ...
    const products: Omit<Product, 'id' | 'arena_id' | 'created_at'>[] = [
        {
            ...
            price: 799.90,
            photo_urls: ['https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/400x400/3b82f6/ffffff?text=Raquete'],
            stock: 15,
            is_active: true,
        },
        {
            ...
            price: 49.90,
            photo_urls: ['https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/400x400/16a34a/ffffff?text=Bolas'],
            stock: 50,
            is_active: true,
        },
        {
            ...
            price: 129.90,
            photo_urls: ['https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/400x400/f97316/ffffff?text=Camiseta'],
            is_active: true,
            variants: [
